    ...
    <header className="container mx-auto px-4 md:px-6 py-4 md:py-6 font-mono border-b-2 border-[#00FF9C]">
      <nav className="flex flex-col md:flex-row justify-between items-start md:items-center">
        ...
        <div className={`${isOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row items-start md:items-center w-full md:w-auto space-y-4 md:space-y-0 md:space-x-8 font-bold mt-6 md:mt-0 pb-4 md:pb-0`}>
          ...
          <a href="https://owasp.org/www-project-top-ten/" target="_blank" rel="noreferrer" className="text-gray-300 hover:text-[#00FF9C] transition-colors cursor-pointer md:hover:-translate-y-1 block">OWASP Top 10</a>
          <a href="https://github.com/sonuhansda/Git-Bytes" target="_blank" rel="noreferrer" className="text-gray-300 hover:text-[#00FF9C] transition-colors cursor-pointer md:hover:-translate-y-1 flex items-center">
